...
public interface AuditLogRepository extends JpaRepository<AuditLog, Long>, JpaSpecificationExecutor<AuditLog> {
       ...
       /**
        * Finds audit logs by entity name and ID with pagination, ordered by performed
        * date descending.
        */
       Page<AuditLog> findByEntityNameAndEntityIdOrderByPerformedAtDesc(String entityName, String entityId,
                     Pageable pageable);

       /**
        * Finds audit logs by user and date range, ordered by performed date
        * descending.
        */
        ...
        */
       Page<AuditLog> findByPerformedAtBetweenOrderByPerformedAtDesc(LocalDateTime startDate, LocalDateTime endDate,
                     Pageable pageable);
       ...
       AuditLog findLatestByEntityNameAndEntityId(@Param("entityName") String entityName,
                     @Param("entityId") String entityId);
       ...
       /**
        * Custom query to find suspicious activities (multiple failed operations from
        * same IP).
        */
       ...
       List<AuditLog> findByEntityNameAndEntityIdIn(@Param("entityName") String entityName,
        ...
        */
       @Query("SELECT a FROM AuditLog a WHERE a.entityName = :entityName AND a.entityId IN :entityIds ORDER BY a.performedAt DESC")
       Page<AuditLog> findByEntityNameAndEntityIdIn(@Param("entityName") String entityName,
                     @Param("entityIds") List<String> entityIds, Pageable pageable);
       ...
       Page<AuditLog> findByOperationAndEntityNameOrderByPerformedAtDesc(
                     @Param("operation") AuditLog.AuditOperation operation,
        ...
        */
       @Query("SELECT CAST(a.performedAt AS DATE), COUNT(a) FROM AuditLog a WHERE a.performedAt BETWEEN :startDate AND :endDate GROUP BY CAST(a.performedAt AS DATE) ORDER BY CAST(a.performedAt AS DATE)")
       List<Object[]> getDailyAuditStats(@Param("startDate") LocalDateTime startDate,
                     @Param("endDate") LocalDateTime endDate);
       ...
       AuditLog findFirstByEntityNameAndEntityId(@Param("entityName") String entityName,
                     @Param("entityId") String entityId);
